...
def lda_sim(s1,s2):
    ...
    dictionary = Dictionary.load('test_lda.dict')
...
if __name__ == '__main__':
    ...
    # get_dict()
    d1 = u'南京长江大桥在哪'
    d2 = u'大桥公园在桥南  而长江大桥好玩的应该在桥北  可以坐132路公交车到桥北的北堡下面 有一站靠近长江边的  在桥下玩玩  然后直接从北堡爬楼梯上长江大桥  就省了很多引桥要走的冤枉路  具体你上132公交车问问司机师傅哪里下  我忘了'
